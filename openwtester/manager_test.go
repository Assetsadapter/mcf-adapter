...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO MCF", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WF9trYUhDdrT4iUXNVC7M3N5wo4XScABmm")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WF9trYUhDdrT4iUXNVC7M3N5wo4XScABmm"
	account := &openwallet.AssetsAccount{Alias: "MCF-test", WalletID: walletID, Required: 1, Symbol: "MCF", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "WF9trYUhDdrT4iUXNVC7M3N5wo4XScABmm"
	accountID := "Dy7K3z2FwmMPv7PeZyf2ppPb3JVSUqVJ4ztQL5KgpAzu"
